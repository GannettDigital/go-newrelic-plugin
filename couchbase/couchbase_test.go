			...
			HTTPRunner: fake.HTTPResult{
				ResultsList: []fake.Result{
					...
					},
					{
						...
						Code:   200,
						Err:    nil,
						Data:   []byte(`{"samplesCount": 60,"isPersistent": true,"lastTStamp": 1510956143435,"interval": 1000,"timestamp": [1510956085435],"nodeStats": {"10.84.87.226:8091": [0, 10]}}`),
					},
				},
			},
			InputLog: logrus.New(),
			...
			ExpectedData: []MetricData{
				{
					...
					"couchbase.replication.some_stats.nodestats":    0,
				},
				{
					"event_type": "CouchbaseReplicationSample",
					"provider":   "couchbase",
					...
					"couchbase.replication.some_stats.interval":     1000,
					"couchbase.replication.some_stats.timestamp":    []int64{1510956085435},
					"couchbase.replication.some_stats.nodestats":    10,
				},
			},
		},
	}
	...
	}{
		{
				...
				ResultsList: []fake.Result{
					{
						...
						Code:   200,
						Err:    nil,
						Data:   []byte(`{"samplesCount": 60,"isPersistent": true,"lastTStamp": 1510956143435,"interval": 1000,"timestamp": [1510956085435],"nodeStats": {"10.84.87.226:8091": [0, 1]}}`),
					},
				},
			},
			InputLog: logrus.New(),
			...
			ExpectedResults: remoteMeticChanResp{
				Data: MetricData{
					...
					"couchbase.replication.some_stats.interval":     1000,
					"couchbase.replication.some_stats.timestamp":    []int64{1510956085435},
					"couchbase.replication.some_stats.nodestats":    1,
				},
				Err: nil,
			},
		},
		{
			TestDescription: "Should successfully process a remote stats request and return summed nodestats results",
			HTTPRunner: fake.HTTPResult{
				ResultsList: []fake.Result{
					{
						Method: "GET",
						...
						Code:   200,
						Err:    nil,
						Data:   []byte(`{"samplesCount": 60,"isPersistent": true,"lastTStamp": 1510956143435,"interval": 1000,"timestamp": [1510956085435],"nodeStats": {"10.84.87.226:8091": [0, 1], "10.84.87.236:8091": [0, 5]}}`),
					},
				},
			},
			InputLog: logrus.New(),
			...
			ExpectedResults: remoteMeticChanResp{
				Data: MetricData{
					...
					"couchbase.replication.some_stats.interval":     1000,
					"couchbase.replication.some_stats.timestamp":    []int64{1510956085435},
					"couchbase.replication.some_stats.nodestats":    6,
				},
				Err: nil,
			},
		},
